...
namespace Repository.Data
{
    class StudentRepository : RepositoryBase<Student>, IStudentRepository
    {
        ...
        public List<Student> GetStudentsIncludeAll() => FindAll().Include(s => s.Profile).ToList();
        public Student GetStudentInclude(int studentId)
        {
            return FindByCondition(a => a.StudentId == studentId).Include(a => a.Profile).FirstOrDefault();
        }
